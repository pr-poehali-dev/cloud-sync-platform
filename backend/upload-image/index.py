...
{{
  ...
  "cases": [
    {{
      "client": "клиент или ниша",
      "task": "задача которую решали",
      "done": "что конкретно сделали",
...
Для поля cases: найди все упоминания проектов, кейсов, портфолио на странице и заполни массив. Если кейсов несколько — добавь все (максимум 5).
